...
def _build_service_with_fakes(saved: dict[str, Any]) -> SignalService:
    ...
    def _build_explanation(**kwargs: Any) -> str:
        ...
        return "No-trade intraday explanation."
...
def test_generate_signal_propagates_no_trade_to_response_and_repository() -> None:
    saved: dict[str, Any] = {}
    ...
    assert response.explanation == "No-trade intraday explanation."
