...
class _IEAListingParser(HTMLParser):
...
class IEAConnector(BaseIntelligenceConnector):
    def __init__(
        self,
        *,
        page_url: str = "https://www.iea.org/energy-system/fossil-fuels/oil",
        source_name: str = "International Energy Agency",
    ...
    def fetch(
        ...
        try:
            ...
            result = ConnectorFetchResult(
                ...
                warnings=[] if items else ["No usable IEA items were found."],
                errors=[],
            )
            return items, result
    ...
    def _validate_request(self, request: ConnectorFetchRequest) -> None:
        if request.source_kind != ConnectorSourceKind.iea:
            raise ValueError("IEAConnector only supports source_kind='iea'.")

        if request.fetch_mode != ConnectorFetchMode.html:
            raise ValueError("IEAConnector only supports fetch_mode='html'.")
    ...
    def _parse_html(
        ...
        *,
        ...
        parser = _IEAListingParser(base_url=self._page_url)
    ...
    def _is_candidate_entry(self, *, title: str, url: str) -> bool:
        ...
        return any(keyword in normalized_title or keyword in normalized_url for keyword in allowed_keywords)
    ...
    def _build_tags(
        ...
        *,
        ...
        keyword_tags = {
            ...
            "oil stocks": "stocks",
            "stocks": "stocks",
            "monthly oil statistics": "monthly_oil_statistics",
            "oil information": "oil_information",
